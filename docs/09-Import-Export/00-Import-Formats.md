...
> The eighteen parsers, what each column becomes, and what is deliberately dropped.
...
> rotted once from eleven to twelve with nothing to catch it, and caught the jump to eighteen.
