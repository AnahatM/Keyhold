...
**Still to come:** folders and tags (Phase 7), attachments (9), the import wizard and
export (10–11), sync (12), settings (14). Import parsing is documented separately in
[`09-Import-Export`](../09-Import-Export/_INDEX.md).
