...
| -------------------------------------------- | ----- | ------------------------------------------------------------------------------------------------------------------------------------------------------------------ |
| [`00-Merge-Engine.md`](./00-Merge-Engine.md) | 12    | Why clocks decide nothing, absence-is-not-deletion and what it costs, the tombstone matrix, how a conflict crosses the bridge as a length, and the caller sequence |
