...
| [`05-Styles-And-The-Token-Split.md`](./05-Styles-And-The-Token-Split.md)       | The second appearance axis — where the style/theme line is drawn and why, why shadows belong to the style whole, the two Holographic numbers that are measured contrast constraints rather than taste, and the failure only a screenshot could find |
