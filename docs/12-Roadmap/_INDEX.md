...
| [`02-Decision-Log.md`](./02-Decision-Log.md)         | ADR-style record of every decision — D1-D22, of which D1-D17 are the founding set and D18-D22 were added as implementation raised them — and the alternatives rejected, plus the five decisions deliberately deferred to implementation. |
